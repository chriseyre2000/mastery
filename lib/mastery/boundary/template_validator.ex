defmodule Mastery.Boundary.TemplateValidator do
  ...
  def errors(_fields), do: [{nil, "A keywors list of fields is required"}]
  ...
  def validate_generator({name, generator}) when is_atom(name) and is_function(generator, 0), do: :ok
