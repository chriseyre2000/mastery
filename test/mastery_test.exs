defmodule MasteryTest do
  ...
  test "Take a quiz, manage lifecycle and persist responses" do
    ...
    assert QuizSession.active_sessions_for(Maths.quiz_fields().title) == []
  end  
  ...
  defp start_quiz(fields) do
    ...
    ending = DateTime.add(now, 60, :second)
    Mastery.schedule_quiz(Maths.quiz_fields(), fields, now, ending) 
  end

  defp take_quiz(email) do
    Mastery.take_quiz(Maths.quiz.title, email)
  end
